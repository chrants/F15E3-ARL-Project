DELETE FROM F15_E3Status
WHERE status_id <= 9 OR status_id >= 1;

DELETE FROM F15_E3Role_Type
WHERE role_id <= 6 OR role_id >= 1;

DELETE FROM F15_E3Emp_Type;

DELETE FROM F15_E3Employee;

INSERT INTO F15_E3Status (status_id, rfe_status, description)
...
INSERT INTO F15_E3Role_Type (role_id, role_type, description)
...
INSERT INTO F15_E3Emp_Type (emp_type)
VALUES ('Standard');
INSERT INTO F15_E3Emp_Type (emp_type)
VALUES ('System Admin');
INSERT INTO F15_E3Emp_Type (emp_type)
...
INSERT INTO F15_E3Employee (EMPLOYEE_NAME, EMPLOYEE_LAB, EMPLOYEE_EMAIL, EMPLOYEE_OFFICE, 
	EMPLOYEE_PHONE, EMPLOYEE_STATUS, STATUS_EFF_DATE)
VALUES ('Jonna Doe', '', 'skfnsdf@kdjfldmsf.com', 'officek dskfkjf', '82348237953', 'A', 34534);
